...
生成日期：2026-09-22。检查基线：`e360b2a1ff8c8c08155b5f7f9ed0df11ec3d635e`（默认分支 `main`）；含本次整理提交的增量。

用途：受约束多模态多目标算法/测试集。

阅读顺序：README → source/ → ARCHIVE_INDEX.md/json。

本清单覆盖 **41 个文件路径**。逐文件路径、类型、历史范围、字节数、Git 内容哈希和适用检查见 [FILEMAP.csv](FILEMAP.csv)。

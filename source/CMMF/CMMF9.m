    ...
    obj.h = zeros(size(PopDec,1),1);
             ...
             for i=1:N
                 if Pop(i,1)>1
                     ...
                     PopCon(i,3)=4 - 4*(2-Pop(i,1))^2-(2-Pop(i,2))^2-0.04;
                     PopCon(i,4)=-4 +4*(2-Pop(i,1))^2+(2-Pop(i,2))^2-0.04;
                 elseif Pop(i,1)<=1
                     PopCon(i,1)=obj.THETA_(i)-2/3;
                     PopCon(i,2)=-obj.THETA_(i)+1/3;
                     PopCon(i,3)=4 - 4*(1-Pop(i,1))^2-Pop(i,2)^2-0.04;
                     PopCon(i,4)=-4 +4*(1-Pop(i,1))^2+Pop(i,2)^2-0.04;
                 end
             end          
             PopCon(PopCon <= 0) = 0;
             PopCon = abs(PopCon);
